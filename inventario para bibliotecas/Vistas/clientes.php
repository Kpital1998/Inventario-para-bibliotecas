...
<body> 
    ...
    <div id="modal">
            <fieldset v-show="mostrar==true" class="animated bounceInDown">
                ...
                <form action="../Controlador/clientes/insertarCliente.php" method="post">
          ...
          <div id="ModalAlerta">
            <fieldset class="animated bounceInDown" v-show="alert==true" >
                ...
                <a v-bind:href="url"><input type="button" value="Eliminar" v-on:click="url='../Controlador/clientes/eliminar.php?id='+id"></a>
                </center>
            </fieldset>
        </div>
        ...
        <div id="main2">
            ...
            <fieldset>
                ...
                <a href="formMODcliente.php?id=<?php echo $datos['Id']; ?>"><input type="button" value="Modificar"></a>
